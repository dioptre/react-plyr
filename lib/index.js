...
var Plyr = function (_Component) {
  ...
  Plyr.prototype.renderPlayerWithSRC = function renderPlayerWithSRC() {
    ...
    if (this.props.sources && Array.isArray(this.props.sources) && this.props.sources.length) {
      toRender = _react2.default.createElement(
        'video',
        { className: 'react-plyr' },
        this.props.sources.map(function (source, index) {
          return _react2.default.createElement('source', { src: source.src, type: source.type });
        })
      );
    } else {
      toRender = _react2.default.createElement('video', {
        className: 'react-plyr',
        src: this.props.url,
        preload: 'none',
  ...
  Plyr.prototype.render = function render() {
    if (this.props.type === 'video') return this.renderPlayerWithSRC();else {
...
Plyr.propTypes = {
  type: _react.PropTypes.oneOf(['youtube', 'vimeo', 'video']),
